import { collapseRanges } from "../report.mts";
import { printDropOutput } from "./check-output.mts";
import type { CoverageCheckResult, DiffLineContent } from "../types.mts";

const stdout = (msg: string) => process.stdout.write(`${msg}\n`);

export function printHumanCheckOutput(
  { buckets, drops, passed }: CoverageCheckResult,
